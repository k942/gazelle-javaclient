...
@AutoProperty
@JsonPropertyOrder({"id", "name", "notificationsEnabled", "hasBookmarked", "image", "body", "vanityHouse", "tags",
		"similarArtists", "statistics", "torrentgroup", "requests"})
public class Artist {
