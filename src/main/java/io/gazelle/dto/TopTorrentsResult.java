...
@AutoProperty
@JsonPropertyOrder({"torrentId", "groupId", "artist", "groupName", "groupCategory", "groupYear", "remasterTitle",
		"format", "encoding", "hasLog", "hasCue", "media", "scene", "year", "tags", "snatched", "seeders", "leechers",
		"data"})
